...
typedef void (*pith_t)(void *, const char *, int);
typedef struct {
  pith_t o;
  void *b;
  int a;
  const char *l;
} a_bark_b_bark_b_50_t;
static void r_pith(void *b_, int r) {
  a_bark_b_bark_b_50_t *b = b_;
  b->o(b->b, b->l, r);
}
static void l_pith(void *b_, const char *l) {
  a_bark_b_bark_b_50_t *b = b_;
  b->l = l;
  b_bark(b, r_pith, b->a);
}
void a_bark_b_bark(void *b_, pith_t o, a_t a) {
  a_bark_b_bark_b_50_t b = {.o = o, .b = b_, .a = a.r};
  a_bark(&b, l_pith, a.l);
}
...
# 1 "/opt2/llvm/lib/clang/11.0.0/include/stddef.h" 1 3 4
# 46 "/opt2/llvm/lib/clang/11.0.0/include/stddef.h" 3 4
typedef long unsigned int size_t;
# 34 "/usr/include/stdio.h" 2 3 4

# 1 "/opt2/llvm/lib/clang/11.0.0/include/stdarg.h" 1 3 4
# 14 "/opt2/llvm/lib/clang/11.0.0/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 32 "/opt2/llvm/lib/clang/11.0.0/include/stdarg.h" 3 4
...
int main() { a_bark_b_bark(0, ab_pith, (a_t){"!", 39}); }
